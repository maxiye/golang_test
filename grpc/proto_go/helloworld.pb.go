...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x4e, 0x69, 0x68, 0x61, 0x6f, 0x12, 0x28, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x48, 0x65,
...
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: Nihao.SayHello:input_type -> HelloRequest
	1, // 1: Nihao.SayHello:output_type -> HelloReply
...
// NihaoClient is the client API for Nihao server.
//
...
func (c *nihaoClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/Nihao/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// NihaoServer is the server API for Nihao server.
type NihaoServer interface {
	// Sends a greeting
	SayHello(context.Context, *HelloRequest) (*HelloReply, error)
}

// UnimplementedNihaoServer can be embedded to have forward compatible implementations.
type UnimplementedNihaoServer struct {
}

func (*UnimplementedNihaoServer) SayHello(context.Context, *HelloRequest) (*HelloReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayHello not implemented")
}

func RegisterNihaoServer(s *grpc.Server, srv NihaoServer) {
	s.RegisterService(&_Nihao_serviceDesc, srv)
}
...
var _Nihao_serviceDesc = grpc.ServiceDesc{
	ServiceName: "Nihao",
